...
window.CATALOG_SERVICE_URL = 'https://localhost:8000';
window.CATALOG_ITEMS_API_URL = `${window.CATALOG_SERVICE_URL}/items`;
window.INVENTORY_SERVICE_URL = 'https://localhost:8001';
window.INVENTORY_ITEMS_API_URL = `${window.INVENTORY_SERVICE_URL}/items`;
window.IDENTITY_SERVICE_URL = 'https://localhost:8002';
window.USERS_API_URL = `${window.IDENTITY_SERVICE_URL}/users`;
window.TRADING_SERVICE_URL = 'https://localhost:8003'
